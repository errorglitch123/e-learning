...
const Footer = () => {
  return (
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
      <div className='flex flex-col items-start md:flex-row px-8 md:px-0 
      justify-center gap-10 md:gap-32 py-10 border-b border-white/30' >
        <div className='flex flex-col md:items-start items-center w-full '>
          <img src={assets.logo_dark} alt="logo" />
          <p className='mt-6 text-center md:text-left text-sm text-white/80'>Thank you for visiting our website! We strive to deliver the best possible experience.
             Please explore our pages, check out our latest updates, and feel free to reach out anytime.</p>
        </div>
        <div className='flex flex-col md:items-start items-center w-full'>
        ...
        <div className='hidden md:flex flex-col items-start w-full'>
          ...
          <div className='flex items-center gap-2 pt-4'>
            ...
            className='border border-gray-500/50 bg-gray-800 text-gray-500
